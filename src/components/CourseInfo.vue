<template>
  ...
  <div class="course-info section px-5 py-5">
    <div class="container">
    ...
    <div class="row g-5">
        ...
        <div class="col-sm-8 ps-sm-5">
              ...
              <h3 v-if="course.recommendedPrerequisites && course.recommendedPrerequisites.length" class="mt-5">Recommended Prerequisites</h3>
              <ul class="list-unstyled h5">
              <li v-for="prereq in course.recommendedPrerequisites" :key="prereq.index" class="mb-2"><i class="bi bi-check-circle mx-3"></i>
              <router-link :to="'/courses/' + prereq">{{prereq}}</router-link>
              </li>
              </ul>
         ...
         <div class="col-sm-4">
             <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <router-link to="/get-started#register" class="btn btn-primary my-3 px-5 py-2">Enroll Now</router-link>
                    </div>
                ...
                <br /><router-link to="/get-started">View The Term Schedule</router-link></p>
...
<div class="how-this-works bg-grey py-5">
  <div class="container">
...
<h4 class="display-2 mb-5">Related Courses</h4>
        ...
        <div class="row card-wrapper row-cols-1 row-cols-4 g-4">
            <!--course card-->
                <div v-for="relatedCourse in relatedCourses" class="col" :key="relatedCourse.courseNumber">
                  <div class="course card h-100">
                    <img :src="relatedCourse.cardImageUrl" class="card-img-top" alt="">
                    <div class="card-body d-flex flex-column">
                      <h5 class="card-title">{{relatedCourse.courseTitle}}</h5>

                      <div class="d-flex flex-row">
                      <span v-for="tag in relatedCourse.courseSubjects" :key="tag.index" class="badge bg-grey text-dark text-wrap p-2 m-1 ">
                          {{ tag }}
                          </span>
                          </div>
                      <p class="card-text">{{relatedCourse.cardText}}</p>

                      <div class="mt-auto me-auto">

                        <h5>${{relatedCourse.coursePrice}}</h5>
                        <router-link class="btn btn-outline-secondary" :to="'/courses/' + relatedCourse.courseNumber">More Info</router-link>
                      </div>
